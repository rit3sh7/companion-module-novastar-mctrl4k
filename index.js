...
// MCTRL4K Display control
instance.prototype.CHOICES_DISPLAY_MODESVX4S = [
	{ id: '0', label: 'Normal' },
	{ id: '1', label: 'Freeze' },
	{ id: '2', label: 'Black' },
//	{ id: '3', label: 'Normal-MCTRL4k' }
]

// MCTRL4k INPUTS
instance.prototype.CHOICES_MCTRL4kINPUTS = [
	{ id: '0', label: 'DVI' },
	{ id: '1', label: 'HDMI' },
	...
	return [
		{
			...
			width: 12,
			label: 'Information',
			value: 'This module will connect to a NovaStar MCTRL4k LED Processor.'
		},
		{
			type: 'textinput',
			id: 'host',
					...
					[
						{
		                    ...
		                    id: 'mctrl4kinput',
							default: '0',
							choices: self.CHOICES_MCTRL4kINPUTS
						}
					]
				},
...
instance.prototype.action = function(action) {
	...
	// change inputs for MCTRL4k
	case 'change_mctrl4kinputs':
					switch(options.mctrl4kinput) {
			case '0':
